...
ITS_FILE="${BR2_EXTERNAL_RPI_OPTEE_PATH}/board/rpi3/rpi3_fit.its"
CONFIG_FILE="${BR2_EXTERNAL_RPI_OPTEE_PATH}/board/rpi3/config.txt"
...
GENIMAGE_CFG="${BR2_EXTERNAL_RPI_OPTEE_PATH}/board/rpi3/genimage-raspberrypi3-64.cfg"
